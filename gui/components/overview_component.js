define([ "jquery", "button" ], function($, Button) {
	 ...
	 * 
	 * @param parent
	 *            DOM-Object that should contain this progressbar, If undefined,
	 *            documnet.body will be used
	 * 
	 * 
	 */
	var OverviewComponent = function(attributes, parent, callback) {
		...
		$(this.container).css({
			...
			if (e.target === _this.container || e.target === _this.label) {
				_this.callback('click', {
					id : _this.id
				});
			}
